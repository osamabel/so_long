...
/*   Updated: 2022/01/18 17:00:04 by obelkhad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	back_idle(t_data *data)
{
	...
	if (frams < FRAMS && i == 0)
		draw_position(data, &i, &frams, "image/saitama/back_idle1.xpm");
	else if (frams < FRAMS && i == 1)
		draw_position(data, &i, &frams, "image/saitama/back_idle2.xpm");
	else if (frams < FRAMS && i == 2)
		draw_position(data, &i, &frams, "image/saitama/back_idle3.xpm");
